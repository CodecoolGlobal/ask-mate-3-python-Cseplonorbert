...
def question_vote_up(question_id):
    if 'email' in session:
        ...
        if session['user_id'] != question['user_id']:
            ...
            data_manager.increase_reputation("question", question_id)
            return redirect(url_for('display_question', question_id=question_id))
        else:
            return redirect(url_for('display_question', question_id=question_id))
    else:
...
def question_vote_down(question_id):
    if 'email' in session:
        ...
        if session['user_id'] != question['user_id']:
            ...
            data_manager.decrease_reputation("question", question_id)
            return redirect(url_for('display_question', question_id=question_id))
        else:
            return redirect(url_for('display_question', question_id=question_id))
    else:
...
def answer_vote_up(answer_id, question_id):
    if 'email' in session:
        ...
        if answer['user_id'] != session['user_id']:
            ...
            data_manager.increase_reputation("answer", answer_id)
    return redirect(url_for('display_question', question_id=question_id))
...
def answer_vote_down(answer_id, question_id):
    if 'email' in session:
        ...
        if answer['user_id'] != session['user_id']:
            ...
            data_manager.decrease_reputation("answer", answer_id)
    return redirect(url_for('display_question', question_id=question_id))
